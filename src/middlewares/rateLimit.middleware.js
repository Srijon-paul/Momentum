...
export const readLimiter = createLimiter(60 * 1000, 100, "Too many requests. Please slow down.");
...
export const adminLimiter = createLimiter(60 * 1000, 30, "Too many requests. Please slow down.");
