                ...
                CreateOpportunityRequest: {
                    ...
                    properties: {
                        ...
                        deadline: {
                            ...
                            pattern: "^\\d{1,2}/\\d{1,2}/\\d{4}$",
                            description:
                                "Deadline in DD/MM/YYYY format. Must be after start_date and not in the past",
                            example: "30/06/2026"
                        }
                    }
                },
                UpdateOpportunityRequest: {
                    ...
                    properties: {
                        ...
                        start_date: {
                            ...
                            pattern: "^\\d{1,2}/\\d{1,2}/\\d{4}$",
                            description:
                                "Optional start date in DD/MM/YYYY format. If provided, it must not be in the past",
                            example: "15/06/2026"
                        },
                        deadline: {
                            type: "string",
                            pattern: "^\\d{1,2}/\\d{1,2}/\\d{4}$",
                            description:
                                "Optional deadline in DD/MM/YYYY format. If provided, it must be after start_date and not in the past",
                            example: "30/06/2026"
                        }
                    }
                },
