...
const addBookmarkControl = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, bookmark, "Bookmark added successfully"));
});
...
const removeBookmarkControl = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, deletedBookmark, "Bookmark removed successfully"));
});

export { addBookmarkControl, getAllBookmarksControl, removeBookmarkControl };
